...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://majkopolo98.github.io";
...
/*    @AfterEach
    ...
    private void removeFromCrudApp(String taskName) throws InterruptedException {
        ...
        driver.findElements(
                ...
                .forEach(theForm -> {
                    WebElement selectElement = theForm.findElement(By.xpath(".//button[@data-task-delete-button]"));
                    selectElement.click();
                });
    }
